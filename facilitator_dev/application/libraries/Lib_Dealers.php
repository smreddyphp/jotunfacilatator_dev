...
class Lib_Dealers
{
     ...
     * @return string[]
     */
    function getDealersList($p_nStatus = NULL, $p_arrColumns = array('id', 'name'))
    {
        // Assign
        list($strIndex, $strValue) = $p_arrColumns;

        // Get users
        $objData = $this->getDealers($p_nStatus);
     ...
     * @return string[]
     */
    function getDealersForPagination($p_nLimit, $p_nOffset, $p_nCreatedBy = NULL, $p_strSearch = NULL, $p_nStatus = NULL)
    {
        // Params
        ...
        return ($objResult->success == true) ? array('objDealers' => $objResult->result, 'nTotalRows' => $objResult->totalCount) : array('objDealers' => array(), 'nTotalRows' => 0, 'message' => $objResult->result->errors[0]->message);
    }
...
/* End of file Lib_Dealers.php */
/* Location: ./application/libraries/Lib_Dealers.php */