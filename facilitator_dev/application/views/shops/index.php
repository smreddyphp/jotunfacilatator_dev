    ...
    <section id="content_wrapper">
        ...
        <header id="topbar" class="ph10">
            <div class="topbar-left">
              ...
              <a class="btn btn-info"  style="padding:4px;float: right;margin-right: 60px;" href="<?php echo base_url(); ?>index.php/shops/add_shop">Add New</a>
                <a class="btn btn-info"  style="padding:4px;float: right;margin-right: 10px;" href="<?php echo base_url(); ?>index.php/sales/download_shops">Download</a>
                <a class="btn btn-info"  style="padding:4px;float: right;margin-right: 10px;" href="<?php echo base_url(); ?>index.php/sales/download_totalshops">Download Total</a>
        </header>
        
       <script src="http://jotunksa.com/facilitator/assets/js/sweetalert.min.js" type='text/javascript'></script>
	
        <section id="content" class="table-layout">
            <div class="tray tray-center">
                
				  <?php if($this->session->flashdata('update') != ""){ ?>
	<?php echo "<script>setTimeout(function() {swal({title: 'Shop updated successfully!'});}, 100);</script>"; ?>
	<?php } ?>
                ...
                <div class="panel">
                    <div class="panel-menu admin-form theme-primary">
                        <div class="row">
                            <div class="form-group">
     <div class="col-md-3" id="shop_filter_replace">
	<label class="field select">		
		<select onchange="shop_filter();" id="shop_type">
		<option value="">Filter By Type</option>
		<?php foreach($types as $shop_types){?>
		<option value="<?php echo $shop_types['id']; ?>"><?php echo $shop_types['name'];?></option>
		<?php } ?>
		</select>
		<i class="arrow double"></i>
                                ...
                                <!-----<div class="col-md-3">
                                    <label class="field select">
           <?php echo form_dropdown('filter_status', array('' => 'Filter By status') + $this->config->item('shops_status'), $this->input->post('filter_status')); ?>
           <select onchange="shops_status_filter();" id="shop_status">
...
<div class="col-md-4">
<label class="field select">
<input name="csv" class="form-control" type="file" id="uploaded_file"/>
</label>
</div>
<div class="col-md-2"><input type="submit" class="btn-sm btn btn-primary upload-csv" id="upload_profile_photo" name="upload_profile_photo" value="Upload CSV" /></div>
                                    <!----<table class="bordered-table">
                                        <tbody>                 
                                            <tr>
                                                <td><input name="csv" class="form-control" type="file" id="uploaded_file"/></td>
                                           
                                                <td><button type="submit" class="btn primary form-control" id="upload_profile_photo" name="upload_profile_photo">Upload CSV</button></td> 
                                            </tr>
                                        </tbody>
                                    </table>----->
                                </form>
    ...
    <div class="col-md-3" id="shop_filter_replace">
            <label for="name2" class="field select">
                <select class="event-name gui-input br-light light" id="zoneshop" onchange="get_shops_zoneshop();">
