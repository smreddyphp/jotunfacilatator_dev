      ...
      <div class="row mb10">
         <div class="inner-header mb10">
            <div class="bread-cumLeft">
               <ol class="breadcrumb">
                  <li>Home</li>
                  <li class="crumb-active">Edit Form</li>
               </ol>
            </div>
         </div>
      </div>
         ...
         <div class="tray tray-center">
            ...
            <div class="panel mb25 mt5">
                <div class="panel-heading">
                    <span class="panel-title hidden-xs">New Form</span>
                </div>
                        ...
                        <div class="section row mbn">
                            <div class="col-md-10 col-sm-10 pl15">
                                <div class="section row mb15">
                                    <?php echo form_open($this->uri->uri_string(), array('id' => 'editFormForm')); ?>
                                        <div class="form-group">
                                            <label for="name" class="col-md-4 col-sm-4 col-xs-12">Name</label>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <label for="name" class="field prepend-icon">
                                                    <?php echo form_input(array('name' => 'name', 'class' => 'event-name gui-input br-light light', 'placeholder' => 'Enter name here', 'value' => set_value('name', $objForm->name))); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <label for="description" class="field prepend-icon">
                                                    <?php echo form_textarea(array('name' => 'description', 'class' => 'event-name gui-input br-light light', 'placeholder' => 'Enter description here', 'value' => set_value('description', $objForm->description))); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <label for="status" class="field select">
                                                    <?php echo form_dropdown('status', $this->config->item('forms_status'), set_value('status', $objForm->status), 'class="select-search"'); ?>
                                                </label>
                                        ...
                                        <div class=" form-group text-right">
                                            <?php echo form_button(array('type' => 'submit', 'content' => 'Update Form', 'class' => 'btn btn-success')); ?>
                                        </div>
                                    <?php echo form_close(); ?>
                                </div>
                                <!-- end section row -->
            ...
            submitHandler: function(form) {
                ...
                if(ajaxResponse.success == true) {
                    ...
                    $(form).find('input[type="submit"]').val('Done!').prop('disabled', false), setTimeout(function(){
                        ...
                        // redirect to index
                        location.href = "<?php echo base_url($this->config->item('forms_index_uri')); ?>";
                    }, 2000);
                }
            }
        });
