    ...
    <div class="row mb10">
      <div class="inner-header mb10">
        <div class="bread-cumLeft">
            <ol class="breadcrumb">
              <li>Home</li>
              <li class="crumb-active">Team Management Form</li>
            </ol>
        </div>      
      </div>
    </div>
...
<!--          <div class="panel mb25 mt5">
            <div class="panel-heading">
              <span class="panel-title hidden-xs"> Add New Form</span>
            </div>
            <div class="panel-body p20 pb10">
                <h4 style="margin-bottom:20px; margin-top:5px">Create a New Form</h4>
                <p><?php echo anchor(base_url($this->config->item('forms_add_uri')), 'Add New Form', 'class="btn btn-success"'); ?></p>
            </div>
          </div>-->
...
<!--              <div class="row">
            ...
            <div class="panel-body pn">
              <div class="table-responsive">
                <?php $this->load->view($this->config->item('forms_table_view')); ?>
              </div>
                <!-- Pagination -->
