        ...
        <div class="row mb10">
            <div class="inner-header mb10">
                <div class="bread-cumLeft">
                    <ol class="breadcrumb">
                        <li>Home</li>
                        <li class="crumb-active">Team Management Role</li>
                    </ol>
                </div>
            ...
            <div class="tray tray-center">
               ...
               <!--- <div class="panel mb25 mt5">
                    <div class="panel-heading">
                        <span class="panel-title hidden-xs"> Add New Role</span>
                    </div>
                    <div class="panel-body p20 pb10">
                        <h4 style="margin-bottom:20px; margin-top:5px">Create a New Role to Access Permisssions</h4>
                        <p><?php echo anchor(base_url($this->config->item('roles_add_uri')), 'Add New Role', 'class="btn btn-success"'); ?>
                    </div>
                </div>---->
<input type="hidden" value="roles" id="table_name">
                <!-- recent orders table -->
                <div class="panel">
                    <div class="panel-heading">
                        <h4><strong>List of Roles</strong></h4>
                    </div>
                    ...
                    <div class="panel-body pn">
                        <div class="table-responsive">
                            <?php $this->load->view($this->config->item('roles_table_view')); ?>
                        </div>
                        <!-- Pagination -->
