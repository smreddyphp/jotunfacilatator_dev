<body class="dashboard-page sb-l-o sb-r-c">
    ...
    margin-right: 13px;
          ...
          form#addRoleForm label.field-icon {
    display: none;
}
            ...
            <div class="inner-header mb10">
                <div class="bread-cumLeft">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-active">Add New Role</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="section row mbn">
                                <div class="col-md-12 pl15">
                                    <div class="section row mb15">
                                        <?php echo form_open($this->uri->uri_string(), array('id' => 'addRoleForm')); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <label for="status" class="field select">
                                                    <?php echo form_dropdown('status', $this->config->item('roles_status'), $this->input->post('status'), 'class="select-search"'); ?>
                                        ...
                                        <div class=" form-group text-right">
                                            <?php echo form_button(array('type' => 'submit', 'content' => 'Create New Role', 'class' => 'btn btn-success')); ?>
                                        </div>
                                        <?php echo form_close(); ?>
                                    </div>
                                    <!-- end section row -->
