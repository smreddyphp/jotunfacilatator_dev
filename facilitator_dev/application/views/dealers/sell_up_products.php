										...
										<div id="example3_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
											...
											<thead>
												<tr role="row">
												    ...
												    <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Name: activate to sort column ascending" style="width: 124px;">Product Name</th>
												    <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Open Date Time: activate to sort column ascending" style="width: 174px;">Added Date</th>
												    <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Close Time: activate to sort column ascending" style="width: 136px;">Status</th>
											...
											<tbody>
											    ...
											    if(!empty($products))
											    {
											        ...
											        <tr class="odd" role="row">
    													...
    													<td><?php echo $product['sell_up_product_name'];?></td>
