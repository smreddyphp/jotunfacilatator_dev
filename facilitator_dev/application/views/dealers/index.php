        ...
        <section id="content_wrapper">
            ...
            <section id="content" class="table-layout animated fadeIn">
                <div class="tray tray-center col-md-12">
                    <div class="panel mb25 mt5">
                        ...
                        <div class="panel-body p20 pb10">
                            ...
                            <p><a href="<?php echo base_url();?>dealers/add" class="btn btn-success">Add New Dealer</a></p>
                            </div>
                    </div>
                </div>
                <div class="panel col-md-12">
                        <div class="panel-heading">
                            <div class="col-md-6">
                                <form action="<?php echo base_url();?>dealers/importcsv_achieved" method="post" enctype="multipart/form-data">
                                <div class="form-group upload_file">
                                    <label>CSV File For Achieved  :&nbsp; </label>
                                    <input type="file" name="csv_file" class="" accept=".csv" required>
                                    <button type="submit" class="btn btn-success csv_upload">Submit</button>
                                </div>
                                </form>
                            </div>
                            <div class="col-md-6">
                                <form action="<?php echo base_url();?>dealers/importcsv" method="post" enctype="multipart/form-data">
                                <div class="form-group upload_file">
                                    <label>CSV File For Add Dealers:&nbsp; </label>
                                    <input type="file" name="csv_file" class="" accept=".csv" required>
                                    <button type="submit" class="btn btn-success csv_upload">Submit</button>
                                </div>
                                </form>
										...
										<div id="example3_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
											...
											<thead>
												<tr role="row">
												    ...
												    <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Duration In Minutes: activate to sort column ascending" style="width: 202px;">Actions</th>
												    <?php if($this->lib_auth->getRoleID() == 1 || $this->lib_auth->getRoleID() == 2){ ?>
											...
											<tbody>
											    ...
											    if(!empty($dealers))
											    {
											        ...
											        <tr class="odd" role="row">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url();?>dealers/edit/<?php echo $dealer->id; ?>" class="btn btn-xs btn-success"><span >Edit</span></a>
                                                            <a href="<?php echo base_url(); ?>sales/report_forms/dealer/<?php echo $dealer->id ?>" class="btn btn-primary br2 btn-xs fs12 report_a">Generate Report</a>
                                                        </td>
