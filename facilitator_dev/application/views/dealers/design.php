...
<?php if($this->lib_auth->getRoleID() == 1){?>
                    <div class="panel mb25 mt5">
                        ...
                        <div class="panel-body p20 pb10">
                            ...
                            <p><?php echo anchor(base_url($this->config->item('dealers_add_uri')), 'Add New Dealer', 'class="btn btn-success"'); ?>
                        </div>
                    </div>
<?php } ?>

	<?php if($this->session->flashdata('message') != ""){ ?>
	<?php echo '<script>setTimeout(function() {swal({title: "Dealer added successfully!"});}, 100);</script>'; ?>
	<?php } ?>

                    <!-- recent orders table -->
                    <div class="panel">
                        <div class="panel-heading">
                            <h4><strong>List of Dealers</strong></h4>
                        </div>
                  ...
                  <label class="field select">
                    <select id="filterdata" onchange="getfilterdealer()" name="filter-group">
                    ...
                    <i class="arrow double"></i>
                               ...
                               <!---- <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                  <label class="field select">
                    <select id="filter-group" name="filter-group"  onchange="mactiondealer();">
                    ...
                    <i class="arrow double"></i>
                        ...
                        <div class="panel-body pn">
                            <div class="table-responsive">
                                <?php $this->load->view($this->config->item('dealers_table_view')); ?>
                            </div>
                            <!-- Pagination -->
