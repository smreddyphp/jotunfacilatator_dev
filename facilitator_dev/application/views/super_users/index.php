            ...
            <div class="row mb10">
                <div class="inner-header mb10">
                    <div class="bread-cumLeft">
                        <ol class="breadcrumb">
                            <li>Home</li>
                            <li class="crumb-active">SuperUser Management</li>
                        </ol>
                    </div>
                ...
                <div class="tray tray-center col-md-12">
                    <div class="panel mb25 mt5">
                        ...
                        <div class="panel-body p20 pb10">
                            ...
                            <p><a href="<?php echo base_url();?>dealers/add_super_user" class="btn btn-success">Add New Superuser</a></p>
                            </div>
                    </div>
                </div>
                                                ...
                                                if(!empty($super_users))
                                                {
                                                    ...
                                                    <tr class="odd" role="row">
                                                       ...
                                                       <?php if($dealer['status'] == 1){?>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url();?>dealers/add_super_user/<?php echo $dealer['id']; ?>" class="btn btn-xs btn-success"><span >Edit</span></a>
                                                        </td>
...
swal({ title: "Are you sure?" ,
        ...
        allowEscapeKey: false
            ...
            url:'<?php echo base_url();?>dealers/deletedata',
            success: function(html){
if(html != ""){         
