            ...
            <div class="inner-header mb10">
                <div class="bread-cumLeft">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-active">Add New Designation</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="section row mbn">
                                <div class="col-md-12 pl15">
                                    <div class="section row mb15">
                                        <?php echo form_open($this->uri->uri_string(), array('id' => 'addDesignationForm')); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <label for="code" class="field prepend-icon">
                                                    <?php echo form_input(array('name' => 'code', 'class' => 'event-name gui-input br-light light', 'placeholder' => 'Enter code here', 'value' => set_value('code'))); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <label for="description" class="field prepend-icon">
                                                    <?php echo form_textarea(array('name' => 'description', 'class' => 'event-name gui-input br-light light', 'placeholder' => 'Enter description here', 'value' => set_value('description'))); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <label for="status" class="field select">
                                                    <?php echo form_dropdown('status', $this->config->item('designations_status'), $this->input->post('status'), 'class="select-search"'); ?>
                                        ...
                                        <div class=" form-group text-right">
                                            <?php echo form_button(array('type' => 'submit', 'content' => 'Create New Designation', 'class' => 'btn btn-success')); ?>
                                        </div>
                                        <?php echo form_close(); ?>
                                    </div>
                                    <!-- end section row -->
