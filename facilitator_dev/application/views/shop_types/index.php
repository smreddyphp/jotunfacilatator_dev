        ...
        <div class="row mb10">
            <div class="inner-header mb10">
                <div class="bread-cumLeft">
                    <ol class="breadcrumb">
                        <li>Home</li>
                        <li class="crumb-active">ShopType</li>
                    </ol>
                </div>
            ...
            <div class="tray tray-center">
                ...
                <div class="panel mb25 mt5">
                    <div class="panel-heading">
                        <span class="panel-title hidden-xs"> Add New ShopType</span>
                    </div>
                    <div class="panel-body p20 pb10">
                        <h4 style="margin-bottom:20px; margin-top:5px">Create a New ShopType</h4>
                        <p><?php echo anchor(base_url($this->config->item('shop_types_add_uri')), 'Add New ShopType', 'class="btn btn-success"'); ?>
                    </div>
                </div>
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h4><strong>List of ShopTypes</strong></h4>
                    </div>
                            ...
                            <div class="col-md-4">
                                <label class="field select">
                                    <select id="filter-status" name="filter-status">
                                        <option value="0">Filter by ShopType</option>
                    ...
                    <div class="panel-body pn">
                        <div class="table-responsive">
                            <?php $this->load->view($this->config->item('shop_types_table_view')); ?>
                        </div>
                        <!-- Pagination -->
