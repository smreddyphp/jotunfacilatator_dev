                                                ...
                                                <div class="col-sm-12 col-md-6" style="display:none">
                                                    ...
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Duration In Minutes: activate to sort column ascending" style="width: 202px;">Employee Name</th><th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Duration In Minutes: activate to sort column ascending" style="width: 202px;">Shop</th>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Duration In Minutes: activate to sort column ascending" style="width: 202px;">View Works</th>
                                            ...
                                            <tbody>
                                                ...
                                                if(!empty($tasks))
                                                {
                                                    ...
                                                    <tr class="odd" role="row">
                                                        ...
                                                        <td><?php echo ($task->emp_id)?$this->db->where('id',$task->emp_id)->get("users")->row()->username:''; ?></td>
                                                        <td><?php echo ($task->shop_id)?$this->db->where('id',$task->shop_id)->get("shops")->row()->name:''; ?></td>
                                                        <td><?php echo $task->created; ?></td>
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>sales/view_form/<?php echo $task->id ?>/<?=$form_id?>" class="btn btn-success br2 btn-xs fs12">View</a>
