            ...
            <div class="row mb10">
                <div class="inner-header mb10">
                    <div class="bread-cumLeft">
                        <ol class="breadcrumb">
                            <li>Home</li>
                            <li class="crumb-active">Forms</li>
                        </ol>
                    </div>
            ...
            <section id="content" class="table-layout animated fadeIn">
                ...
                <div class="panel col-md-12">
                        <div class="panel-heading">
                            <h4><strong>List of Forms</strong></h4>
                        </div>
                        <div class="panel-body pn">
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Sr.No: activate to sort column descending" style="width: 46px;">name</th></th>
                            ...
                            <?php 
                                if(!empty($forms))
                                {
                                    ...
                                    <tr class="odd" role="row">
                                        ...
                                        <td><a href="<?php echo base_url(); ?>sales/view_user_works/<?php echo $user_id ?>/<?=$form->id?>" class="btn btn-success br2 btn-xs fs12">View Form</a></td>
                                <?php } } ?>
                            </tbody>
                            </table></div></div>
                            <div class="row">
