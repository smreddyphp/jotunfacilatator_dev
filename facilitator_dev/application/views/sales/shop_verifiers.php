                        ...
                        <div class="panel-body pn">
							...
							<thead>
								<tr role="row">
								    ...
								    <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Duration In Minutes: activate to sort column ascending" style="width: 202px;">Name</th>
								    ...
								    <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Duration In Minutes: activate to sort column ascending" style="width: 202px;">View</th>
											...
											<tbody>
											    ...
											    if(!empty($employees))
											    {
                                                    ...
                                                    <td><a href="<?php echo base_url(); ?>sales/forms/<?php echo $user->id ?>" class="btn btn-success br2 btn-xs fs12">View Works</a></td>
											       <?php } } ?>
											</tbody>
										</table></div></div>
										<div class="row">
