...
<a href="<?php echo base_url(); ?>index.php/sales/salesexcel/<?php echo $objUser->id;?>/<?php echo $objUser->form->id;  ?>" class="btn btn-sm btn btn-primary " style="    margin-left: 920px;">Download</a>
            </div>
        </header>
        <!-- End: Topbar -->
        ...
        <section id="content" class="table-layout">
            ...
            <div class="tray tray-center" style="height: 598px;">
                ...
                <!-- recent orders table -->
<?php if($objUser->shops == ""){?>
<?php }else{?>
                <?php foreach($objUser->shops as $objShop): ?>
                  <div class="panel">
                      <div class="panel-body pn">
                          <div class="container">
                              <div class="row p-t-sm">
                                  <div class="col-md-2 " align="center">
<?php if($objShop->shop_image == "") {?>
<img src="<?php echo base_url(); ?>server/assets/media/default-shop-icon.png" class="img-responsive img_form">
<?php } else { ?>
                                  <?php echo img(array('src' => $this->config->item('base_url').$this->config->item('shops_image_path').$objShop->shop_image), '','class="img-responsive img_form"'); ?>
<?php } ?>
                                   </div>
                                  <div class=" col-md-10">
...
<td> <?php echo anchor(base_url($this->config->item('sales_shop_details_view_uri').$objShop->task_form->task_id.'/'.$objShop->task_form->id.'/'.$objShop->task_form->form_id), 'View Details', 'class="btn btn-sm btn-success"'); ?></td>

<?php if($rows != ""){?>                                          
<td><span class="btn btn-sm btn-danger" disabled="disabled" onclick="unassigntask('<?php echo $objShop->task_form->task_id; ?>','<?php echo $objShop->task_form->id; ?>');">Unassign</span></td>
<?php }else{ ?>
<td><span class="btn btn-sm btn-danger" onclick="unassigntask('<?php echo $objShop->task_form->task_id; ?>','<?php echo $objShop->task_form->id; ?>');">Unassign</span></td>
<?php } ?>
                                              </tr>
                                              </tbody>
                                          </table>
