                ...
                <div class="panel col-md-12">
                        ...
                        <div class="row">
                          <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle dataTable no-footer" >
                            ...
                            <tbody>
                              <tr>
                                <td><div class="col-md-6">Sales Visit </div></td>
                                <td><div class="col-md-6">: <?php echo $form_data->sales_visit; ?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">Are All the POSM available in the shop    </div></td>
                                <td><div class="col-md-6">: <?=$form_data->posm?></div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6"> If No what is missing </div></td>
                                <td><div class="col-md-6">: <?=$form_data->missing?></div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6"> Are All Color Chips available in JCCE & JCCI </div></td>
                                <td><div class="col-md-6">: <?=$form_data->color_chips?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6"> Is The LED playing Jotun Vide </div></td>
                                <td><div class="col-md-6">: <?=$form_data->led_playing?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6"> Are there any old campaign display(posters, danglers, rollup) still in the shop </div></td>
                                <td><div class="col-md-6">: <?=$form_data->old_campaign?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6"> (If Yes then Get it removed) </div></td>
                                <td><div class="col-md-6">: <?php echo $form_data->get_removed; ?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">Explain all Ongoing Campaigns (Sales, Push, End User, Salesman Incentive) </div></td>
                                <td><div class="col-md-6">: <?php echo $form_data->explain_campaigns; ?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">Inform about Sales & Collection Target </div></td>
                                <td><div class="col-md-6">: <?php echo $form_data->sales_target; ?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">Sales Forecast </div></td>
                                <td><div class="col-md-6">: <?php echo $form_data->sales_forecast; ?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">Collection Forecast</div></td>
                                <td><div class="col-md-6">: <?php echo $form_data->collection_forecast; ?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">Jotun Way Completed for Saudi Sales Staff </div></td>
                                <td><div class="col-md-6">: <?php echo $form_data->jotun_way_completed; ?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">If No provide the date when he would be available </div></td>
                                <td><div class="col-md-6">: <?php echo $form_data->jotun_way_date; ?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">Roleplay for Selling Up, On Job Training</div></td>
                                <td><div class="col-md-6">: <?php echo $form_data->roleplay; ?> </div></td>
                              </tr>
