                ...
                <div class="panel col-md-12">
                        ...
                        <div class="row">
                          <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle dataTable no-footer" >
                            ...
                            <tbody>
                              <tr>
                                <td><div class="col-md-6">No of Openings </div></td>
                                <td><div class="col-md-6">: <?php echo $form_data[0]->no_openings; ?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">New Concept </div></td>
                                <td><div class="col-md-6">: <?=$form_data[0]->new_concept?></div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">Flagship Store </div></td>
                                <td><div class="col-md-6">: <?=$form_data[0]->flag_ship_store?></div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">Shop type </div></td>
                                <td><div class="col-md-6">: <?=$form_data[0]->shop_type?> </div></td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
                            ...
                            $i=1;
                              ...
                              ?>
											        <tr class="odd" role="row">
    													<td><?php echo $i++; ?></td>
                              <td><?php echo $form->sales_man_staff; ?></td>
                              <td><?php echo ($form->status == 1) ? "Salesman":"Staff"; ?></td>
                              <td><?php echo $form->nationality; ?></td>
                              <td><?php echo $form->phone_no; ?></td>
                              <td><?php echo $form->experience; ?></td>
											       <?php
                           }
											    }
											    ?>
