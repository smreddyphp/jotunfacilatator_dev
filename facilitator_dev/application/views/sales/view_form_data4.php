                ...
                <div class="panel col-md-12">
                        ...
                        <div class="row">
                          <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle dataTable no-footer" >
                            ...
                            <tbody>
                              <tr>
                                <td><div class="col-md-6">Dealer Owner Name </div></td>
                                <td><div class="col-md-6">: <?php echo $form_data->dealer_name; ?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6">Occupation  </div></td>
                                <td><div class="col-md-6">: <?=$form_data->occupation?></div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6"> Phone Number </div></td>
                                <td><div class="col-md-6">: <?=$form_data->phone_number?></div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6"> Email </div></td>
                                <td><div class="col-md-6">: <?=$form_data->email?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6"> Hometown </div></td>
                                <td><div class="col-md-6">: <?=$form_data->home_town?> </div></td>
                              </tr>
                              <tr>
                                <td><div class="col-md-6"> Address </div></td>
                                <td><div class="col-md-6">: <?=$form_data->address?> </div></td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
