            ...
            <div class="row mb10">
                <div class="inner-header mb10">
                    <div class="bread-cumLeft">
                        <ol class="breadcrumb">
                            <li>Home</li>
                            <li class="crumb-active">Forms List</li>
                        </ol>
                    </div>
                </div>
            </div>
								...
								<tr role="row">
								    ...
								    <th >View Form</th>
											...
											<tbody>
											    <?php
                          //echo "<pre>";
                          //print_r($task_forms);exit;
											    if(!empty($task_forms))
											    {
											        $i=1;
											        foreach($task_forms as $task){ ?>
											        <tr class="odd" role="row">
    													<td><?php echo $i++; ?></td>
                              <td><?php echo $task->name; ?></td>
                              <td>
                                <span class="label <?php echo ($task->tf_status == 1) ? 'label-info' : 'label-success'; ?>">
                                    <?php echo ($task->tf_status == 1) ? "Pending": "Completed"; ?>
                                </span>
                              </td>
                              <td>
                                <?php echo ($task->tf_status == 1) ? 'Not Available':'<a href="'.base_url().'sales/view_form_data/'.$task->task_form_id.'/'. $task->form_id.'" class="btn btn-success br2 btn-xs fs12">View Form</a>'; ?>
                              </td>
											       <?php }
											    }
											    ?>
