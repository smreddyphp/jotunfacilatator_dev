        ...
        <section id="content_wrapper">
            ...
            <div class="row mb10">
                <div class="inner-header mb10">
                    <div class="bread-cumLeft">
                        <ol class="breadcrumb">
                            <li>Home</li>
                            <li class="crumb-active">Tasks List</li>
                        </ol>
                    </div>
            ...
            <section id="content" class="table-layout animated fadeIn">
                ...
                <div class="panel col-md-12">
                        <div class="panel-heading">
                            <h4><strong>List of Tasks</strong></h4>
                        </div>
										...
										<div id="example3_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
										        ...
										        <div class="col-sm-12 col-md-6" style="display:none">
                        							...
                        							<thead>
                        								<tr role="row">
                        								    ...
                        								    <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Name: activate to sort column ascending" style="width: 124px;">Dealer</th>
                        								    <?php if(@$shop != ""){?>
                        								    <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Duration In Minutes: activate to sort column ascending" style="width: 202px;">Employee Name</th>
                        								    <?php }else{ ?>
                                                        <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Duration In Minutes: activate to sort column ascending" style="width: 202px;">Shop</th>
                                                        <?php } ?>
                        								    <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Open Date Time: activate to sort column ascending" style="width: 174px;">Assigned By</th>
                        								    ...
                        								    <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Duration In Minutes: activate to sort column ascending" style="width: 202px;">Date</th>
                        								    <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Exam Duration In Minutes: activate to sort column ascending" style="width: 202px;">View Task Forms</th>
											...
											<tbody>
											    ...
											    if(!empty($tasks))
											    {
											        ...
											        $d_name = $this->db->query("select * from users where acc_no in(select distinct(acc_no) from shops where id=$task->shop_id)")->row()->username;
											        ?>
											        <tr class="odd" role="row">
    													<td class="sorting_1"><?php echo $i++; ?></td>
                                                        <td><?php echo ($task->shop_id)?$d_name:'';?></td>
                                                        <?php if(@$shop != ""){?>
                                                        <td><?php echo ($task->user_id)?$this->db->where('id',$task->user_id)->get("users")->row()->username:''; ?></td>
                                                        <?php }else{ ?>
                                                        <td><?php echo ($task->shop_id)?$this->db->where('id',$task->shop_id)->get("shops")->row()->name:''; ?></td>
                                                        <?php } ?>
                                                        <td><?php echo ($task->assigned_by)?$this->db->where('id',$task->assigned_by)->get("users")->row()->username:''; ?></td>
                                                        <td>
                                                          <span class="label <?php echo ($task->status == 1) ? 'label-default' : 'label-primary'; ?>">
                                                              <?php echo ($task->status == 1) ? 'Pending' : 'Completed'; ?>
                                                          </span>
                                                        </td>
                                                        <td><?php echo $task->created; ?></td>
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>sales/view_task_forms/<?php echo $task->id ?>" class="btn btn-success br2 btn-xs fs12">Task Forms</a>
                                                            <?php if($task->status == 1){ ?>
                                                            <a href="<?php echo base_url(); ?>sales/delete_task/<?php echo $task->id ?>" class="btn btn-danger br2 btn-xs fs12">Delete Task</a>
                                                            <?php } ?>
                                                            <!--<a href="<?php echo base_url(); ?>sales/task_edit/<?php echo $task->user_id ?>/<?php echo $task->id ?>" class="btn btn-primary br2 btn-xs fs12">Task Edit</a>-->
                                                        </td>
