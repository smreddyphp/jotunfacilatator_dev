...
require APPPATH .'/libraries/v1/services/Services_Constants.php';
...
class Lib_Services
{
    ...
    public function get_targets($duration,$user_id)
    {
      return $this->ci->services_m->user_targets($duration,$user_id);
    }

    public function get_dealer_shops_data($user_id)
    {
      return $this->ci->services_m->dealer_shops($user_id);
    }

    public function get_user($user_id)
    {
      return $this->ci->services_m->get_user_data($user_id);
    }

    public function get_shop($shop_id)
    {
      return $this->ci->services_m->get_shop_data($shop_id);
    }

    public function get_shop_tasks($user_id,$shop_id,$status)
    {
        return $this->ci->services_m->get_single_shop_tasks($user_id,$shop_id,$status);
    }
    public function add_new_task_default_form($user_id,$shop_id){
      return $this->ci->services_m->add_default_form($user_id,$shop_id);
    }

    public function forms()
    {
        return $this->ci->services_m->get_task_forms();
    }

    public function add_form_data($table,$data)
    {
        return $this->ci->services_m->add_task_forms_data($table,$data);
    }
