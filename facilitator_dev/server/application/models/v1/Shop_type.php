...
class Shop_type extends CI_Model
{
    /**
     * __construct method
     */
    ...
    {
        $this->_table = $this->config->item('shop_types_table');
    }
     ...
     * @return boolean
     */
    function checkShopTypeExistByID($p_nID) 
    {
        $this->db->where('id', $p_nID);
     ...
     * @return object
     */
    function getShopTypesForPagination($p_nLimit = null, $p_nOffset = null, $p_strSearch = null, $p_nStatus = null)
    {
        $this->db->select("$this->_table.*");

        if($p_strSearch)
        {
            $this->db->like('first_name', $p_strSearch);
            $this->db->or_like('first_name', $p_strSearch);
        }
     ...
     * @return integer
     */
    function getNoOfShopTypes($p_strSearch = null, $p_nStatus = null)
    {
